...
| リンク                                                                                                      | 説明                                   |
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| [フォント (Jeroit)](https://github.com/omonomo/Jeroit/releases/download/v1.1.1/Jeroit_v1.1.1.zip)           | 通常版。半角幅が全角の1/2。            |
| [フォント (JeroitLoose)](https://github.com/omonomo/Jeroit/releases/download/v1.1.1/JeroitLoose_v1.1.1.zip) | 文字間隔ゆるい版。半角幅が全角の9/16。 |
| [ソースコード](https://github.com/omonomo/Jeroit/archive/refs/tags/v1.1.1.zip)                              | 使用方法は下の方にあります。           |
